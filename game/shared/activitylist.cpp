...
//HL2MP
...
#ifdef GE_DLL
	// GE SPECIFIC ACTIONS
	REGISTER_SHARED_ACTIVITY ( ACT_GES_ATTACK_RUN_PRIMARYFIRE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DRAW );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_HOLSTER );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DRAW_RUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_HOLSTER_RUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_AIMMODE_START );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_AIMMODE_END );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_CJUMP );

	REGISTER_SHARED_ACTIVITY ( ACT_VM_SECONDARYATTACK_SILENCED ); // For Dualed Weapons
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DRYFIRE_SECONDARY );
	...
	// MINE ACTIONS
	REGISTER_SHARED_ACTIVITY ( ACT_VM_MINE_TO_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_WATCH_TO_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_WATCH_DETONATE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_WATCH_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_WATCH_DRAW );
	// GRENADE ACTIONS
	REGISTER_SHARED_ACTIVITY ( ACT_VM_GRENADE_PULLPIN );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_GRENADE_THROW1 );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_GRENADE_THROW2 );

	// THIRD PERSON ANIMATIONS
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_RCP90 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_SLAPPERS );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_SNIPERRIFLE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_CMAG );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_RL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_TKNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_IDLE_GRENADE );

	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_RCP90 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_SLAPPERS );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_SNIPERRIFLE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_CMAG );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_RL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_TKNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_RUN_GRENADE );

	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_RCP90 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_SLAPPERS );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_SNIPERRIFLE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_CMAG );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_RL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_TKNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_WALK_GRENADE );

	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_RCP90 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_SLAPPERS );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_SNIPERRIFLE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_CMAG );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_RL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_TKNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_JUMP_GRENADE );

	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_AR33 );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_RCP90 );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_MINE );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_WATCH );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_PHANTOM );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_SLAPPERS );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_SNIPERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_CMAG );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_RL );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_TKNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_GES_CJUMP_GRENADE );

	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RELOAD_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RELOAD_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RELOAD_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RELOAD_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RELOAD_CMAG );

	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_RCP90 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_KNIFE_RUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_SLAPPERS );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_CMAG );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_RL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_TKNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_RANGE_ATTACK_GRENADE );

	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_DRAW_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_DRAW_PISTOL_RUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_DRAW_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_DRAW_RIFLE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_GESTURE_DRAW_KNIFE );

	// NPC Animations (w/ events!)
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_AR33 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_AUTOSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_RCP90 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_KNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_MINE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_WATCH );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_PHANTOM );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_SLAPPERS );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_CMAG );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_RL );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_TKNIFE );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_NPC_RANGE_ATTACK_GRENADE );

	// Death animations
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_KNEE1 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_KNEE2 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_KNEE3_HAND );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_KNEE4 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_SPIN1 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_SPIN64 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_FB1 );
	REGISTER_SHARED_ACTIVITY ( ACT_GES_DEATH_NECK1 );
#endif
