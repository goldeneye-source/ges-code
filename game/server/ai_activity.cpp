...
//===========================
	...
	// GE SPECIFIC ACTIONS
	ADD_ACTIVITY_TO_SR( ACT_GES_ATTACK_RUN_PRIMARYFIRE );
	ADD_ACTIVITY_TO_SR( ACT_GES_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_GES_HOLSTER );
	ADD_ACTIVITY_TO_SR( ACT_GES_DRAW_RUN );
	ADD_ACTIVITY_TO_SR( ACT_GES_HOLSTER_RUN );
	ADD_ACTIVITY_TO_SR( ACT_GES_AIMMODE_START );
	ADD_ACTIVITY_TO_SR( ACT_GES_AIMMODE_END );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP );

	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK_SILENCED ); // For Dualed Weapons
	ADD_ACTIVITY_TO_SR( ACT_VM_DRYFIRE_SECONDARY );
	...
	// MINE ACTIONS
	ADD_ACTIVITY_TO_SR ( ACT_VM_MINE_TO_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_VM_WATCH_TO_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_VM_WATCH_DETONATE );
	ADD_ACTIVITY_TO_SR ( ACT_VM_WATCH_IDLE );
	ADD_ACTIVITY_TO_SR ( ACT_VM_WATCH_DRAW );
	// GRENADE ACTIVITIES
	ADD_ACTIVITY_TO_SR ( ACT_VM_GRENADE_PULLPIN );
	ADD_ACTIVITY_TO_SR ( ACT_VM_GRENADE_THROW1 );
	ADD_ACTIVITY_TO_SR ( ACT_VM_GRENADE_THROW2 );

	// THIRD PERSON ANIMATIONS
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_RCP90 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_SLAPPERS );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_SNIPERRIFLE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_CMAG );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_RL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_TKNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_IDLE_GRENADE );

	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_RCP90 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_SLAPPERS );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_SNIPERRIFLE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_CMAG );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_RL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_TKNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_RUN_GRENADE );

	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_RCP90 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_SLAPPERS );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_SNIPERRIFLE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_CMAG );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_RL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_TKNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_WALK_GRENADE );

	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_RCP90 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_SLAPPERS );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_SNIPERRIFLE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_CMAG );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_RL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_TKNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_JUMP_GRENADE );

	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_AR33 );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_RCP90 );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_KNIFE );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_MINE );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_WATCH );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_PHANTOM );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_SLAPPERS );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_SNIPERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_CMAG );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_RL );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_TKNIFE );
	ADD_ACTIVITY_TO_SR( ACT_GES_CJUMP_GRENADE );

	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RELOAD_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RELOAD_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RELOAD_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RELOAD_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RELOAD_CMAG );

	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_RCP90 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_KNIFE_RUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_SLAPPERS );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_CMAG );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_RL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_TKNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_RANGE_ATTACK_GRENADE );

	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_DRAW_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_DRAW_PISTOL_RUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_DRAW_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_DRAW_RIFLE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_GESTURE_DRAW_KNIFE );

	// NPC Animations (w/ events!)
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_AR33 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_PISTOL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_AUTOSHOTGUN );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_RCP90 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_KNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_MINE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_WATCH );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_PHANTOM );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_SLAPPERS );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_CMAG );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_RL );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_TKNIFE );
	ADD_ACTIVITY_TO_SR ( ACT_GES_NPC_RANGE_ATTACK_GRENADE );

	// Death animations
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_KNEE1 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_KNEE2 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_KNEE3_HAND );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_KNEE4 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_SPIN1 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_SPIN64 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_FB1 );
	ADD_ACTIVITY_TO_SR ( ACT_GES_DEATH_NECK1 );
#endif
}
